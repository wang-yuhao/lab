...
alignItems="center" sx={{
  ...
  <Grid xs={4}  className="pt-5 square border border-dark">
    <Grid xs={8} justifyContent="center" className="square border border-dark">
      <Item>1</Item>
      <Item>1</Item>
      <Item>1</Item>
    </Grid>
  </Grid>
  <Grid xs={8} className="pt-5 square border border-dark">
